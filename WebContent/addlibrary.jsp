...
<div id="header">
	...
	%>
    	...
    	<form name=F1 onSubmit="return dil(this)" action="addlibraryprocess.jsp" >
			...
			out.print("</div>"); 
			 ...
			 %>
					...
					<!--tr><td>M:</td><td> <input type="password" name="password"/></td></tr>-->
												...
												<TR>
	<TD> LIBRARY   :</TD> <TD> <SELECT NAME="library"> 
									<option value=a > LIBRARY A 
									<option value=b > LIBRARY B
									<option value=c > LIBRARY C
