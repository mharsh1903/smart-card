...
<div id="header">
	...
	%>
    	...
    	<form name=F1 onSubmit="return dil(this)" action="addmessprocess.jsp" >
			...
			out.print("</div>"); 
			 ...
			 %>
					...
					<!--tr><td>M:</td><td> <input type="password" name="password"/></td></tr>-->
								...
								<TR>
	<TD> MESS   :</TD> <TD> <SELECT NAME="mess"> 
									<option value=a > MESS A 
									<option value=b > MESS B
									<option value=c > MESS C
